...
public class OrderSorterHelperTests {
	...
	private String testFileInput = "I:\\Projects\\Personal-Projects\\Pizza Shop\\src\\main\\resources\\data\\sample_data_ordered.txt";
	private String testFileOutput = "I:\\Projects\\Personal-Projects\\Pizza Shop\\src\\main\\resources\\data\\test_file_output.txt";
	...
	public void testLogBuildingSameFoodItems() {
		...
		OrderLog automatedOrderLog = orderSorterHelper.createOrderLog(testFileInput);
	...
	public void testWritingToAFile() {
		...
		OrderLog originalDataOrderLog = orderSorterHelper.createOrderLog(testFileInput);
		orderSorterHelper.writeOrderLogToFile(originalDataOrderLog, testFileOutput);
		...
		try {
			...
			Scanner inputReading = new Scanner(new FileReader(testFileOutput));
